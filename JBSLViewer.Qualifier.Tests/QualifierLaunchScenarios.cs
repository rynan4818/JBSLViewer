    ...
    internal static class QualifierLaunchScenarios
    {
        ...
        private static async Task Challenge()
        {
            using (var rig = new LaunchRig())
            {
                ...
                Program.Check(call.MapColors == rig.Map.Level.MapColors && call.Environments == rig.Environments,
                    "direct launch preserves the map color scheme and installed environment model");
