...
public interface IBeatmapLevelData { bool ContainsBeatmapData(BeatmapKey key); }
public sealed class TestLevelData : IBeatmapLevelData
{
    public bool Contains = true;
    public bool ContainsBeatmapData(BeatmapKey key) => Contains;
}
...
public enum PlaymodeOptions { Default }
public sealed class GameplayAdditionalInformation
{
    public readonly string backButtonText;
    public readonly bool useTestNoteCutSoundEffects, startPaused;
    public readonly PlaymodeOptions playmodeOptions;
    public readonly string recordingRelativePath;
    public GameplayAdditionalInformation(string backButtonText = null, bool useTestNoteCutSoundEffects = false,
        bool startPaused = false, PlaymodeOptions playmodeOptions = PlaymodeOptions.Default, string recordingRelativePath = null)
    {
        this.backButtonText = backButtonText; this.useTestNoteCutSoundEffects = useTestNoteCutSoundEffects;
        this.startPaused = startPaused; this.playmodeOptions = playmodeOptions; this.recordingRelativePath = recordingRelativePath;
    }
}
namespace BGLib.Polyglot { public static class Localization { public static string Get(string key) => "Menu"; } }
...
public sealed class ColorSchemesSettings
{
    ...
    public bool OverrideLightshow;
    public bool ShouldOverrideLightshowColors() => OverrideLightshow;
...
public sealed class MenuTransitionsHelper
{
    public sealed class Invocation
    {
        ...
        public Action<StandardLevelScenesTransitionSetupDataSO, LevelCompletionResults> Restarted;
    }
    public readonly List<Invocation> Calls = new List<Invocation>();
    public Action<Invocation> OnStart;
    public void StartStandardLevel(string mode, in BeatmapKey key, BeatmapLevel level,
        OverrideEnvironmentSettings environment, ColorScheme colors, bool overrideLightshow, GameplayModifiers modifiers,
        PlayerSpecificSettings settings, PracticeSettings practice, EnvironmentsListModel environments,
        GameplayAdditionalInformation additionalInformation, Action beforeSwitch, Action<Zenject.DiContainer> afterSwitch,
