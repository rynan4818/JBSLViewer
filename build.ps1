param(
    [string]$GameDirectory = 'C:/Program Files (x86)/Steam/steamapps/common/Beat Saber_1.42.0',
    [string]$ModReferencesDir = 'C:/Program Files (x86)/Steam/steamapps/common/Beat Saber_1.42.3',
    [string]$MSBuildPath,
